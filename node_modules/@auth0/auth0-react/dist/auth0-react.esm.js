...
var Auth0Provider = function (opts) {
    ...
    var client = useState(function () { return new Zc(toAuth0ClientOptions(clientOpts)); })[0];
...
export { Auth0Context, Auth0Provider, uc as InMemoryCache, sc as LocalStorageCache, OAuthError, Pc as User, initialContext, useAuth0, withAuth0, withAuthenticationRequired };
